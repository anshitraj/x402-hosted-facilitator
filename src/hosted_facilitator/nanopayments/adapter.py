...
class NanopaymentAdapter:
    ...
    async def pay_x402_url(
        ...
        from hosted_facilitator.nanopayments.types import ResourceInfo
        ...
        updated_kind = PaymentRequirementsKind(
            ...
            extra=PaymentRequirementsExtra(
                ...
                version=gateway_kind.extra.version or "1",
                verifying_contract=verifying_contract,
                min_validity_seconds=gateway_kind.extra.min_validity_seconds,
                assets=gateway_kind.extra.assets,
            ),
        )
