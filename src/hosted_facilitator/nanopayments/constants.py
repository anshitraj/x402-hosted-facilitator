...
API Reference:
    ...
    Endpoints (all relative to base URL):
        ...
        GET  /v1/x402/transfers/{id} — reconcile a Gateway transfer
...
GATEWAY_X402_TRANSFER_PATH_TEMPLATE: str = "/v1/x402/transfers/{id}"
"""Path template for x402 transfer reconciliation by Circle transfer UUID."""
...
MAX_TIMEOUT_SECONDS: int = 604900  # 7 days plus buffer
"""
Maximum timeout for payment authorization validity.
Circle's Gateway SDK uses 604900 seconds for batched x402 settlement.
"""

MIN_VALID_BEFORE_SECONDS: int = 604800  # 7 days
"""
Minimum validity window for EIP-3009 authorization.
Gateway live supported metadata advertises a 604800 second minimum validity window.
"""

DEFAULT_VALID_BEFORE_SECONDS: int = 604900  # 7 days plus buffer
"""
Default validity window for EIP-3009 authorization.
Set to 7 days plus a small buffer to match Circle Gateway batching requirements.
"""
